...
## Overview
This is a 3D portfolio website built using React, tailwindcss, and Node.js for the backend. The website showcases projects, experience, and skills in an interactive 3D environment which is island and
the home page will also play the music when you visit the website.

## Features
- 3D Interactive UI powered by Three.js
- Smooth Animations using fiber/drei
